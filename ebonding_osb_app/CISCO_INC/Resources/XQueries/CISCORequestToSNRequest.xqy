...
local:func($SourceSystem,$TransactionType,$Impact, $Urgency, $StatusDestinationValue,$ResolutionCodeDestinationValue,$CauseCodeDestinationValue,$Category,$SubCategory,$CISCORequest)